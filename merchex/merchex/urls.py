...
urlpatterns = [
    ...
    path('bands/<int:id>/modif/', views.band_update, name='band-update'),
    ...
    path('listings/<int:id>/modif', views.listing_update, name='listing-update'),
    path('listings/<int:id>/delete/', views.listing_delete, name='listing-delete'),
    path('contact-us', views.contact, name='contact'),
    path('sent', views.mail_sent, name='email-sent')
]
